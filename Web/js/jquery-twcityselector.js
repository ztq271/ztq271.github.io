! function(i, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("TwCitySelector", [], t) : "object" == typeof exports ? exports.TwCitySelector = t() : i.TwCitySelector = t() }(window, function() { return function(i) { var t = {};

        function n(s) { if (t[s]) return t[s].exports; var o = t[s] = { i: s, l: !1, exports: {} }; return i[s].call(o.exports, o, o.exports, n), o.l = !0, o.exports } return n.m = i, n.c = t, n.d = function(i, t, s) { n.o(i, t) || Object.defineProperty(i, t, { enumerable: !0, get: s }) }, n.r = function(i) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(i, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(i, "__esModule", { value: !0 }) }, n.t = function(i, t) { if (1 & t && (i = n(i)), 8 & t) return i; if (4 & t && "object" == typeof i && i && i.__esModule) return i; var s = Object.create(null); if (n.r(s), Object.defineProperty(s, "default", { enumerable: !0, value: i }), 2 & t && "string" != typeof i)
                for (var o in i) n.d(s, o, function(t) { return i[t] }.bind(null, o)); return s }, n.n = function(i) { var t = i && i.__esModule ? function() { return i.default } : function() { return i }; return n.d(t, "a", t), t }, n.o = function(i, t) { return Object.prototype.hasOwnProperty.call(i, t) }, n.p = "", n(n.s = 0) }([function(i, t, n) { "use strict";
        n.r(t); var s = { counties: ["台北市", "基隆市", "新北市", "宜蘭縣", "桃園市", "新竹市", "新竹縣", "苗栗縣", "台中市", "彰化縣", "南投縣", "嘉義市", "嘉義縣", "雲林縣", "台南市", "高雄市", "澎湖縣", "金門縣", "屏東縣", "台東縣", "花蓮縣", "連江縣"], districts: [
                    [
            ...
            o = { counties: ["Taipei City", "Keelung City", "New Taipei City", "Yilan County", "Taoyuan City", "Hsinchu City", "Hsinchu County", "Miaoli County", "Taichung City", "Changhua County", "Nantou County", "Chiayi City", "Chiayi County", "Yunlin County", "Tainan City", "Kaohsiung City", "Penghu County", "Kinmen County", "Pingtung County", "Taitung County", "Hualien County", "Lienchiang County"], districts: [
                    [
        ...
        function e(i, t) { for (var n = 0; n < t.length; n++) { var s = t[n];
                s.enumerable = s.enumerable || !1, s.configurable = !0, "value" in s && (s.writable = !0), Object.defineProperty(i, s.key, s) } } var a = function() {
            function i() { var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                    s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}; return function(i, t) { if (!(i instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, i), n.length && this.checkOptionsRequired(t, n), this.setOptionsExtend(t, s) } var t, n, s; return t = i, (n = [{ key: "checkOptionsRequired", value: function(i, t) { var n = ""; if (i = i || {}, Object.keys(t).forEach(function(t) { i.hasOwnProperty(t) || (n += t + ",") }), n) throw "缺少參數: " + n } }, { key: "setOptionsExtend", value: function(i, t) { if (!i) return t; var n; for (n in i) t[n] = i[n]; return t } }]) && e(t.prototype, n), s && e(t, s), i }();
        t.default = h;

        function h() { var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            this.VERSION = "2.0.0", this.ROLE_ATTR_NAME = "tw-city-selector"; var t = i.length ? ["el"] : []; return this.options = new a(i, t, { el: null, elCounty: null, elDistrict: null, elZipcode: null, only: null, except: null, disabled: !1, hasZipcode: !1, hiddenZipcode: !1, countyValue: null, districtValue: null, countyClassName: "county", countyFieldName: "county", districtClassName: "district", districtFieldName: "district", zipcodeClassName: "zipcode", zipcodeFieldName: "zipcode", lang: "zh-tw", standardWords: !1, bootstrapStyle: !1 }), setTimeout(function() {
                (function() { if (this.options.el) return this.el = u(this.options.el), this.elCounty = u(this.options.elCounty, this.el), this.elDistrict = u(this.options.elDistrict, this.el), this.elZipcode = u(this.options.elZipcode, this.el), this.elCounty && this.elCounty.dataset.value && (this.options.countyValue = this.elCounty.dataset.value, this.options.districtValue = this.elDistrict.dataset.value), r.call(this); var i = document.querySelectorAll("[role=" + this.ROLE_ATTR_NAME + "]"); return Array.prototype.forEach.call(i, function(i) { var t = JSON.parse(JSON.stringify(this)); return t.el = i, t.elCounty = null, t.elDistrict = null, t.elZipcode = null, t = function() { return this.options.only = this.el.getAttribute("data-only") ? this.el.getAttribute("data-only").replace(/\s/g, "").split(",") : null, this.options.except = this.el.getAttribute("data-except") ? this.el.getAttribute("data-except").replace(/\s/g, "").split(",") : null, this.options.countyValue = this.el.getAttribute("data-county-value"), this.options.districtValue = this.el.getAttribute("data-district-value"), this.options.hasZipcode = null != this.el.getAttribute("data-has-zipcode"), this.options.hiddenZipcode = null != this.el.getAttribute("data-hidden-zipcode"), this.options.disabled = null != this.el.getAttribute("data-disabled"), this.options.standardWords = null != this.el.getAttribute("data-standard-words"), this.options.bootstrapStyle = null != this.el.getAttribute("data-bootstrap-style"), this }.call(t), r.call(t) }, this), i }).call(this) }.bind(this), 0), this }

        function r() { return this.options.lang && "en-us" === this.options.lang ? this.data = o : this.data = s,
                function() { var i = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                        t = i ? "台" : "臺",
                        n = i ? "臺" : "台";
                    this.data.counties = this.data.counties.map(function(i) { return i.includes(t) ? i.replace(t, n) : i }), this.data.districts.forEach(function(i, s, o) { o[s][0] = i[0].map(function(i) { return i.includes(t) ? i.replace(t, n) : i }) }) }.call(this, this.options.standardWords),
                function() { var i = document.createDocumentFragment(); if (!this.elCounty) { var t = document.createElement("select");
                        this.elCounty = t, i.appendChild(this.elCounty) } this.elCounty.classList.add(this.options.countyClassName), this.elCounty.name = this.options.countyFieldName, this.options.disabled && this.elCounty.setAttribute("disabled", !0); if (function() { var i = this.elCounty;
                            this.options.lang && "en-us" === this.options.lang ? i.options.add(new Option("Select County/City", "")) : i.options.add(new Option("選擇縣市", "")); for (var t = function() { var i = this.options.only; return "string" == typeof i ? i : Array.isArray(i) ? i.map(function(i) { var t = i.indexOf("@"); return -1 === t ? i : i.substring(0, t) }) : null }.call(this), n = function() { var i = this.options.except; return "string" == typeof i ? i : Array.isArray(i) ? i.filter(function(i) { return -1 === i.indexOf("@") }) : null }.call(this), s = 0, o = this.data.counties.length; s < o; s++)
                                if (!(t && -1 === t.indexOf(this.data.counties[s]) || n && -1 !== n.indexOf(this.data.counties[s]))) { var e = new Option(this.data.counties[s], this.data.counties[s]);
                                    e.dataset.index = s, i.options.add(e) } return !0 }.call(this), !this.elDistrict) { var n = document.createElement("select");
                        this.elDistrict = n, i.appendChild(this.elDistrict) } this.elDistrict.classList.add(this.options.districtClassName), this.elDistrict.name = this.options.districtFieldName, this.options.disabled && this.elDistrict.setAttribute("disabled", !0); if (c.call(this), !this.elZipcode && this.options.hasZipcode) { var s = document.createElement("input");
                    ...
                    this.elCounty.setAttribute("class", "form-control"), this.elDistrict.setAttribute("class", "form-control"), this.options.hasZipcode && this.elZipcode.setAttribute("class", "form-control"); var t = document.createElement("div");
                    t.setAttribute("class", "form-group"); var n = t.cloneNode();
                    n.appendChild(this.elCounty), i.appendChild(n); var s = t.cloneNode(); if (s.appendChild(this.elDistrict), i.appendChild(s), this.options.hasZipcode) { var o = t.cloneNode();
                        o.appendChild(this.elZipcode), i.appendChild(o) } this.el.appendChild(i) }.call(this),
                function() { var i = function() { var i = this.elCounty.querySelector("option:checked"),
                            t = i.getAttribute("data-index");
                        c.call(this, t), this.options.hasZipcode && (this.elZipcode.value = "") }.bind(this);
                    this.elCounty.onchange = i }.call(this),
                function() { var i = function() { var i = this.elDistrict.querySelector("option:checked"),
                            t = i.dataset.zipcode || "";
                        (this.options.hasZipcode || this.elZipcode) && (this.elZipcode.value = t) }.bind(this);
                    this.elDistrict.onchange = i }.call(this), l.call(this, this.options.countyValue, this.options.districtValue), this }

        function u(i, t) { return i ? i && t ? t.querySelector(i) : document.querySelector(i) : null }

        function c() { for (var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = this.elDistrict; t.firstChild;) t.removeChild(t.firstChild); if (this.options.lang && "en-us" === this.options.lang ? t.options.add(new Option("Select District", "")) : t.options.add(new Option("選擇區域", "")), !i) return !0; for (var n = function(i) { var t = this.options.only,
                        n = "string" == typeof t; if (!n && !Array.isArray(t)) return null;
                    n && (t = [t]); var s = null; return t.forEach(function(t) { if (-1 !== t.indexOf(i)) { var n = t.lastIndexOf("@"); return -1 !== n ? s = t.substring(n + 1).split("|") : void 0 } }), s }.call(this, this.elCounty.value), s = function(i) { var t = this.options.except,
                        n = "string" == typeof t; if (!n && !Array.isArray(t)) return null;
                    n && (t = [t]); var s = null; return t.forEach(function(t) { if (-1 !== t.indexOf(i)) { var n = t.lastIndexOf("@"); return -1 !== n ? s = t.substring(n + 1).split("|") : void 0 } }), s }.call(this, this.elCounty.value), o = 0, e = this.data.districts[i][0].length - 1; o <= e; o++)
                if (!(n && -1 === n.indexOf(this.data.districts[i][0][o]) || s && -1 !== s.indexOf(this.data.districts[i][0][o]))) { var a = new Option(this.data.districts[i][0][o], this.data.districts[i][0][o]);
                    a.dataset.zipcode = this.data.districts[i][1][o], t.options.add(a) } return !0 }

        function l() { var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                n = document.createEvent("Event");
            n.initEvent("change", !0, !0), i && (this.elCounty.value = i, this.elCounty.dispatchEvent(n)), t && (this.elDistrict.value = t, this.elDistrict.dispatchEvent(n)) } h.prototype.getVersion = function() { return console.log("Your tw-city-selector.js is v" + this.VERSION), this }, h.prototype.setValue = function() { var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
...
$(window).on('load', function() {
    // city selector
    // https://dennykuo.github.io/tw-city-selector/archive/v1/
    new TwCitySelector({
        el: ".city-selector",
        elCounty: ".city-county", // 在 el 裡查找 dom
        elDistrict: ".city-district", // 在 el 裡查找 dom
        elZipcode: ".city-zipcode" // 在 el 裡查找 dom
    });

    new TwCitySelector({
        el: '.city-selector-set',
        elCounty: '.city-county', // 在 el 裡查找 element
        elDistrict: '.city-district', // 在 el 裡查找 element
        elZipcode: '.city-zipcode' // 在 el 裡查找 element
    });
    new TwCitySelector({
        el: '.city-selector-set2',
        elCounty: '.city-county', // 在 el 裡查找 element
        elDistrict: '.city-district', // 在 el 裡查找 element
        elZipcode: '.city-zipcode' // 在 el 裡查找 element
    });
    new TwCitySelector({
        el: '.city-selector-set3',
        elCounty: '.city-county', // 在 el 裡查找 element
        elDistrict: '.city-district', // 在 el 裡查找 element
        elZipcode: '.city-zipcode' // 在 el 裡查找 element
    });
